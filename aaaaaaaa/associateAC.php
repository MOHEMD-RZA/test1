...
<head>
	                <meta charset="utf-8"> 
	                <title>مقرر قسم المحاسبة</title> 
                  <link rel="stylesheet" href="aassoo.css"> 	       
</head>  
<body dir="rtl">
             <form action="associateAC.php" method="POST">
                  ...
                  <input type="text" value="تقنيات المحاسبة" class="te3" name='namee'>
  ...
  $sql=mysqli_query($conn,"insert into student(Student_name,sec_name,stage,groupp,zo)VALUES ('$Student_name','$sec_name','$stage','$group','$zo')");
                      ...
                      ?>
                        <!-- عرض البيانات -->
                        <?php
                                  $result=mysqli_query($conn,"select *from student where sec_name='تقنيات المحاسبة' AND zo=1");
                                      echo "<table border=2 width='100%' align='center' height='60' class='ta' bgcolor='white'>";
                                      echo "<tr align='center'  width='600' height='55'  class='trr' >";
                                      echo "<td width='5%'><b>التسلسل</b></td>";
                                      echo "<td width='30%'><b>الاسم</b></td>";
                                      echo "<td width='22%'><b>القسم</b></td>";
                                      echo "<td width='20%' ><b>المرحلة</td>";
                                      echo "<td><b>الشعبة</td>";
                                      echo "<td><b>تعديل</td>";
                                      echo "<td ><b>حذف</td></tr>";
                                      $count = 0;
                          while($row=mysqli_fetch_array($result)){
                              $count++;
                                      ...
                                      echo "<td class='hh'><a  target=_blank href='bbbAC.php?id=$row[id]' >تعديل</a></td>"; //target=_blankلفتح صفحة اخرى 
                                      echo "<td  class='hh'><a href='deAC.php?id=$row[id]' >حذف</a></td>";
                                       echo "</tr>";
                                                               }
                                                                echo "</table>";?>
                     </div>
